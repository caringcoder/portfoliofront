...
const iconsPath = [
    {
        ...
        href: "https://github.com/caringcoder"
    },
    {
        name: "linkedin",
        ...
        href: "https://www.linkedin.com/in/aditya-raj-chauhan-689038220/"
    },
    {
        name: "instagram",
                                ...
                                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                    {
                                        iconsPath.map((element, index) => {
                                            return (
                                                <li className="nav-item" key={index}>
                                                    <a className="nav-link active" aria-current="page" href={element.href} target='_blank' rel='noreferrer'>
